    ...
    setZoomPicture: function(options) {
      ...
      var diaporama = {
        ...
        _attachThumbsEvent: function() {
          ...
          $(this._opt.prevContainer).click(function(e) {
            me._previous(e);
          });

          $(this._opt.nextContainer).click(function(e) {
            me._next(e);
          });
        },
        ...
        _showPicture: function(thumb) {
          $(this._opt.thumbsContainer).find('img').css('background', '');
      ...
      // Returns each jQuery object-------------------------------------------

      return this.each(function() {
        // Add the current jQuery object to the 'options' collection------------
        _options.jObject = $(this);

        // Creating a wait message while loading--------------------------------
        $(this).find('img').hide();
        ...
        // Loading the slideshow class at the end of the download
        $(window).on('load', function() {
          $('#loading').remove();

          // Initializing the 'slideshow' class
